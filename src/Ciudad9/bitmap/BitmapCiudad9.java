...
public class BitmapCiudad9 {
    ...
    public void dibujarEstadoCombate(JugadorCombate jugador, List<Enemigo> enemigos) {
        ...
        bmp.drawText("Vida: " + jugador.getVida(), 50, 125, FUENTE_NORMAL, COLOR_JUGADOR, COLOR_FONDO);
        bmp.drawLine(50, 150, 750, 150, Color.GRAY);
        bmp.drawText("ENEMIGOS:", 50, 180, FUENTE_NORMAL, COLOR_ENEMIGO, COLOR_FONDO);

        int y = 210;
        for (Enemigo e : enemigos) {
            bmp.drawText("- " + e.getNombre() + "  Vida: " + e.getVida(), 50, y, FUENTE_NORMAL, COLOR_ENEMIGO, COLOR_FONDO);
            y += 30;
        }
    }
    ...
    public void dibujarVictoria() {
        ...
        bmp.drawText("Derrotaste a todos los enemigos.", 200, 320, FUENTE_NORMAL, COLOR_TEXTO, COLOR_FONDO);
    }

    public void dibujarDerrota() {
        bmp.rellenar(COLOR_FONDO);
        bmp.drawText("DERROTA", 320, 280, FUENTE_TITULO, Color.RED, COLOR_FONDO);
        bmp.drawText("El jugador fue eliminado.", 230, 320, FUENTE_NORMAL, COLOR_TEXTO, COLOR_FONDO);
    }
